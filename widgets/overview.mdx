...
description: "Extra blocks on your profile — markdown infobox, embed, gear shelf, portfolio, Steam inventory, plus three legacy single-link types."
keywords: ["widget", "widgets", "blocks", "extras", "extra content", "premium", "pages", "scroll", "scroll hint", "scroll pages", "scroll for more", "embed", "embeds", "iframe", "youtube widget", "discord invite widget", "telegram widget", "infobox", "markdown block", "gear", "gear shelf", "portfolio", "steam", "inventory", "steam inventory", "split profile", "sections"]
---
...
The `profileWidgetSchema` is a union of **eight** widget shapes. Five are first-class types you can add new instances of from the dashboard:
