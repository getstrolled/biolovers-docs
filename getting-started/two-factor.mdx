...
See [I lost my 2FA](/troubleshooting/lost-2fa). Short version: if you set up the same TOTP secret on a backup device or password manager, use that. Otherwise, contact support.
